...
@interface VideoRechargeViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation VideoRechargeViewController
#pragma mark - 重写
...
-(void)requestData{
    __weak __typeof(self) weakSelf = self;
    //tag : 0 视频 1同城2写真
    [MineApi requestPayCenterInfoWithTag:@"0" Success:^(NSArray * _Nonnull payCenterInfotemArr, NSString * _Nonnull msg) {
