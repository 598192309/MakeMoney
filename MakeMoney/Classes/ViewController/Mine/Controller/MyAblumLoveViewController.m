...
@implementation MyAblumLoveViewController
#pragma mark - life
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)requestData{
    __weak __typeof(self) weakSelf = self;
    [MineApi requestAblumLoveListWithPageIndex:@"0" page_size:@"15" Success:^(NSInteger status, NSString * _Nonnull msg, NSArray * _Nonnull hotItemArr) {
...
- (void)requestMoreData{
    __weak __typeof(self) weakSelf = self;
    [MineApi requestAblumLoveListWithPageIndex:IntTranslateStr(self.pageIndex) page_size:@"15" Success:^(NSInteger status, NSString * _Nonnull msg, NSArray * _Nonnull hotItemArr) {
