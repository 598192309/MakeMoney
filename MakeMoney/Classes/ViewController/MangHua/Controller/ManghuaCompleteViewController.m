//
//  ManghuaCompleteViewController.m
//  MakeMoney
//
...
@interface ManghuaCompleteViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ManghuaCompleteViewController
#pragma mark - life
- (void)viewDidLoad {
    [super viewDidLoad];
