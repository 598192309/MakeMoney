//
//  ManghuaLianzaiViewController.m
//  MakeMoney
//
...
@interface ManghuaLianzaiViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ManghuaLianzaiViewController
#pragma mark - life
- (void)viewDidLoad {
    [super viewDidLoad];
