...
- (void)initializeUIView
{
    if ((self.pageNormals.count == 0 && 0 < _numberOfPages) || self.pageNormals.count != _numberOfPages)
    {
        ...
        for (int i = 0; i < _numberOfPages; i++)
        {
            ...
            [self.pageNormals safeAddObject:imageViewNormal];
            ...
            [self.pageSelecteds safeAddObject:imageViewSelected];
            ...
            [self.labelNormals safeAddObject:labelNormal];
            ...
            [self.labelSelecteds safeAddObject:labelSelected];
        }
    }
}
