...
@property (nonatomic,strong) NSMutableArray *childVCArr;   //子控制器数组（childVCArr.count 必须 == source.count）
/* tabBar必须设置的属性 */
@property (nonatomic,strong) NSMutableArray *source;       //@[@{@"title":@"首页", @"selImg":@"", @"norImg":@""}]
